...
# version:      1.0
# author:       wujiawei0926
# email:        wujiawei0926@yeah.net
#
# 使用说明：
# 1: 该脚本使用前需要首先修改 MAIN_CLASS 值，使其指向实际的启动类
#
# 2：使用命令行 ./robot.sh start | stop | restart 可启动/关闭/重启项目
#
...
MAIN_CLASS=com.xuexiang.xupdateservice.XUpdateServiceApplication
...
JAVA_OPTS="-server -Xms256m -Xmx256m -Xmn512m -XX:MetaspaceSize=64m -XX:MaxMetaspaceSize=256m"
